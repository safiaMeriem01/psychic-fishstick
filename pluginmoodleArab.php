...
<head>
    ...
    <title>Automated generation of short-answer questions</title>
    <style>
        form {
            border: none;
    ...
    <center>
        ...
        <form method="post">
            ...
            <div class="banc">
                ...
                <input type="text" style="width: 160pt;height: 17pt;" name="bank" id="bank" value="<?php echo isset($_POST['bank']) ? $_POST['bank'] : ''; ?>"  placeholder=" اسم بنك الأسئلة">
            </div>
            <br>
            ...
            <div class="Q1">
                ...
                <input id="Question" type="text" name="Question"  onmouseup="copierMot()" value="<?php echo isset($_POST['Question']) ? $_POST['Question'] : ''; ?>" placeholder=" نص السؤال">
                <label name="mark" for="mark1"> علامة</label> <input id=" mark1" type="number" min="0" max="20" name="mark" value="<?php echo isset($_POST['mark']) ? $_POST['mark'] : '1'; ?>" style="height: 20pt; width:  25pt;">
            </div>
            <br>
            ...
            <div class="R1" id="monFormulaire">
                ...
                <input id="answer1" type="text" name="Reponse1" onmouseup="copierMot()" value="<?php echo isset($_POST['Reponse1']) ? $_POST['Reponse1'] : ''; ?>" placeholder="نص الإجابة ">
                <label for="mark1">  ن.مئوية</label> <input id="mark1" type="text" name="prctg1" value="<?php echo isset($_POST['prctg']) ? $_POST['prctg'] : '100%'; ?>" style="height: 20pt; width:  26pt;"><br>
                <br>
            </div>
            ...
            if (isset($_POST['rows']) && isset($_POST['cols'])&& isset($_POST['answer'])) {
                ...
                for ($j = 2; $j <= $answer; $j++) {
                    ...
                    echo '<label for="answer1">نص الإجابة' . $j . '</label>';
            ...
            <br> <br> <br>
            <!-----------------------------------LOAD---------------------------------->
            <form action="loadArab.php" method="post">

    ...
    session_start(); 
        ...
        <form method="post">
            ...
            <div class="banc">
                ...
                <input type="text" style="width: 160pt;height: 17pt;" name="bank" id="bank" value="<?php  echo  $_SESSION['bank']; ?>"  placeholder=" name of question bank">
            </div>
            <br>
            <br>
            <?php 
...
?>
            ...
            <div class="Q1">
                ...
                <input id="Question" type="text" name="Question"  onmouseup="copierMot()" value="<?php echo $_SESSION['Question']?>" placeholder=" question text">
                <label name="mark" for="mark1"> Mark</label> <input id=" mark1" type="number" min="0" max="20" name="mark" value="<?php echo $_SESSION['mark'] ?>" style="height: 20pt; width:  25pt;">
            </div>
            <br>
            ...
            <div class="R1" id="monFormulaire">
                ...
                <input id="answer1" type="text" name="Reponse1" onmouseup="copierMot()" value="<?php echo $_SESSION['Reponse1']?>" placeholder=" answer text">
                <label for="mark1"> Prcg</label> <input id="mark1" type="text" name="prctg1" value="<?php echo $_SESSION['prctg1'] ?>" style="height: 20pt; width:  26pt;"><br>
                <br>
            </div>
            ...
            for ($j = 2; $j <= $answer; $j++) {
                ...
                echo '<label for="answer' . $j . '">Answer text' . $j . '</label>';
...
<!--------------nombre d'answer,fields,questions et botton generate  ----------------------->
    <!---------------nombre d'answer  ----------------------->
    <label for="answer">Number of answer:</label>
            ...
            <table id="myTable">
                ...
                <tbody class="tbl2">
                    <tr>
                        ...
                        <td><input name="field1" id="champCopie1" value="<?php echo  isset( $_POST['1f1']) ? $_POST['1f1'] : $_SESSION['similar_0_field_0']; ?>" class="td"> </td>
                        <td><select id="langue" name="langue">
                                ...
                                <option>English java Primitive Type</option>
